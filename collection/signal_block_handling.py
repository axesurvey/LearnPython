...
logname = "C:/Users/eyulcui/Dropbox/LearnPython/raw_log/typical_trace.txt"
...
with open(logname) as input_file:
    for index, line in enumerate(input_file):
        ...
        if stateMachine[0] == 1:
            ...
            print (stateMachine,signal_block_checker)
            ...
            if (index - each_sig_loc[1]) >= 200:
                print("signal is borken or more than 200")
                print("Line number is: " + str(each_sig_loc[1]))
                stateMachine = [0, 0, 0]
                ...
                line_ie = re.compile(r'([\w]+[\w|\d]*)\s+(\d+)', re.M | re.I)
